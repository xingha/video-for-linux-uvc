...
static uint8_t jpegQuality = 70;
static char* jpegFilename = NULL;
static char* jpegFilenamePart = NULL;

static std::string deviceName= "/dev/video0";
...
*/
static void jpegWrite(uint8_t* img, char* jpegFilename)
{
...
static void deviceInit(void)
{
    ...
    // if(cap.capabilities & V4L2_CAP_VIDEO_CAPTURE){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VIDEO_CAPTURE\n");
    // }else{
    //     printf("不支持V4L2_CAP_VIDEO_CAPTURE\n");
    // }
    // if(cap.capabilities & V4L2_CAP_STREAMING){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_STREAMING\n");
    // }else{
    //     printf("不支持V4L2_CAP_STREAMING\n");
    // }
    // if(cap.capabilities & V4L2_CAP_VIDEO_OUTPUT){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VIDEO_OUTPUT\n");
    // }else{
    //     printf("不支持V4L2_CAP_VIDEO_OUTPUT\n");
    // }
    // if(cap.capabilities & V4L2_CAP_VIDEO_OVERLAY){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VIDEO_OVERLAY\n");
    // }else{
    //     printf("不支持V4L2_CAP_VIDEO_OVERLAY\n");
    // }
    // if(cap.capabilities & V4L2_CAP_VBI_CAPTURE){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VBI_CAPTURE\n");
    // }else{
    //     printf("不支持V4L2_CAP_VBI_CAPTURE\n");
    // }
    // if(cap.capabilities & V4L2_CAP_VBI_OUTPUT){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VBI_OUTPUT\n");
    // }else{
    //     printf("不支持V4L2_CAP_VBI_OUTPUT\n");
    // }
    // if(cap.capabilities & V4L2_CAP_SLICED_VBI_CAPTURE){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_SLICED_VBI_CAPTURE\n");
    // }else{
    //     printf("不支持V4L2_CAP_SLICED_VBI_CAPTURE\n");
    // }
    // if(cap.capabilities & V4L2_CAP_SLICED_VBI_OUTPUT){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_SLICED_VBI_OUTPUT\n");
    // }else{
    //     printf("不支持V4L2_CAP_SLICED_VBI_OUTPUT\n");
    // }
    // if(cap.capabilities & V4L2_CAP_RDS_CAPTURE){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_RDS_CAPTURE\n");
    // }else{
    //     printf("不支持V4L2_CAP_RDS_CAPTURE\n");
    // }
    // if(cap.capabilities & V4L2_CAP_VIDEO_OUTPUT_OVERLAY){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VIDEO_OUTPUT_OVERLAY\n");
    // }else{
    //     printf("不支持V4L2_CAP_VIDEO_OUTPUT_OVERLAY\n");
    // }
    // if(cap.capabilities & V4L2_CAP_HW_FREQ_SEEK){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_HW_FREQ_SEEK\n");
    // }else{
    //     printf("不支持V4L2_CAP_HW_FREQ_SEEK\n");
    // }
    // if(cap.capabilities & V4L2_CAP_HW_FREQ_SEEK){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_HW_FREQ_SEEK\n");
    // }else{
    //     printf("不支持V4L2_CAP_HW_FREQ_SEEK\n");
    // }
    // if(cap.capabilities & V4L2_CAP_VIDEO_CAPTURE_MPLANE){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VIDEO_CAPTURE_MPLANE\n");
    // }else{
    //     printf("不支持V4L2_CAP_VIDEO_CAPTURE_MPLANE\n");
    // }
    // if(cap.capabilities & V4L2_CAP_VIDEO_OUTPUT_MPLANE){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VIDEO_OUTPUT_MPLANE\n");
    // }else{
    //     printf("不支持V4L2_CAP_VIDEO_OUTPUT_MPLANE\n");
    // }
    // if(cap.capabilities & V4L2_CAP_VIDEO_M2M_MPLANE){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VIDEO_M2M_MPLANE\n");
    // }else{
    //     printf("不支持V4L2_CAP_VIDEO_M2M_MPLANE\n");
    // }
    // if(cap.capabilities & V4L2_CAP_VIDEO_M2M){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_VIDEO_M2M\n");
    // }else{
    //     printf("不支持V4L2_CAP_VIDEO_M2M\n");
    // }
    // if(cap.capabilities & V4L2_CAP_TUNER){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_TUNER\n");
    // }else{
    //     printf("不支持V4L2_CAP_TUNER\n");
    // }
    // if(cap.capabilities & V4L2_CAP_AUDIO){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_AUDIO\n");
    // }else{
    //     printf("不支持V4L2_CAP_AUDIO\n");
    // }
    // if(cap.capabilities & V4L2_CAP_RADIO){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_RADIO\n");
    // }else{
    //     printf("不支持V4L2_CAP_RADIO\n");
    // }
    // if(cap.capabilities & V4L2_CAP_MODULATOR){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_MODULATOR\n");
    // }else{
    //     printf("不支持V4L2_CAP_MODULATOR\n");
    // }
    // if(cap.capabilities & V4L2_CAP_SDR_CAPTURE){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_SDR_CAPTURE\n");
    // }else{
    //     printf("不支持V4L2_CAP_SDR_CAPTURE\n");
    // }
    // if(cap.capabilities & V4L2_CAP_EXT_PIX_FORMAT){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_EXT_PIX_FORMAT\n");
    // }else{
    //     printf("不支持V4L2_CAP_EXT_PIX_FORMAT\n");
    // }
    // if(cap.capabilities & V4L2_CAP_SDR_OUTPUT){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_SDR_OUTPUT\n");
    // }else{
    //     printf("不支持V4L2_CAP_SDR_OUTPUT\n");
    // }
    // if(cap.capabilities & V4L2_CAP_READWRITE){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_READWRITE\n");
    // }else{
    //     printf("不支持V4L2_CAP_READWRITE\n");
    // }
    // if(cap.capabilities & V4L2_CAP_ASYNCIO){/*判断是否支持视频流捕获*/
    //     printf("支持V4L2_CAP_ASYNCIO\n");
    // }else{
    //     printf("不支持V4L2_CAP_ASYNCIO\n");
    // }
	...
	if (width != fmt.fmt.pix.width) {
		...
		fprintf(stderr,"Image width set to %i by device %s.\n", width, deviceName.c_str());
	}

	if (height != fmt.fmt.pix.height) {
		height = fmt.fmt.pix.height;
		fprintf(stderr,"Image height set to %i by device %s.\n", height, deviceName.c_str());
	}
  ...
  if (fps != -1)
  {
	...
	if(-1 == xioctl(fd, VIDIOC_G_PARM, &frameint))
    {
...
static void deviceOpen(void)
{
	...
	if (S_ISCHR(st.st_mode)) {
		...
		fd = open(deviceName.c_str(), O_RDONLY | O_CLOEXEC);
	}
...
{
	char temp[]={};
	sprintf(temp,"%s",dev_name);
	deviceName = std::string(temp);
